      ...
      <div className="card p-6 mb-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div>
            ...
            <p className="text-base font-medium text-surface-100 mt-1">{data.contact_name || user?.displayName || 'N/A'}</p>
            <p className="text-sm text-surface-400">
              {data.contact_email || user?.email ? (
                <span className="flex items-center gap-1.5 mt-0.5">
                  <svg className="w-3.5 h-3.5 text-surface-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                  {data.contact_email || user?.email}
                </span>
              ) : 'N/A'}
            </p>
            <p className="text-sm text-surface-400">
              {data.contact_phone || user?.phone ? (
                <span className="flex items-center gap-1.5 mt-0.5">
                  <svg className="w-3.5 h-3.5 text-surface-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                  {data.contact_phone || user?.phone}
                </span>
              ) : 'N/A'}
            </p>
